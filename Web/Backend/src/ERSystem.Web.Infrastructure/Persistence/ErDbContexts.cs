...
public sealed class LegacyErDbContext(DbContextOptions<LegacyErDbContext> options) : DbContext(options)
{
    ...
    internal static void ConfigureLegacy(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ExpenseDetailEntity>(entity =>
        {
            ...
            entity.Property(x => x.PerDiem).HasColumnName("ExpensePerdiem").HasMaxLength(1).IsUnicode(false);
            entity.Property(x => x.Particulars).HasColumnName("ExpenseParticulars").IsUnicode(false);
            entity.Property(x => x.InvoiceNumber).HasColumnName("ExpenseInvoice").HasMaxLength(25).IsUnicode(false);
            entity.Property(x => x.Multiplier).HasColumnName("ExpenseMultiplier");
            entity.Property(x => x.ExpenseType).HasColumnName("ExpenseType").HasMaxLength(10).IsUnicode(false);
            ...
            entity.Property(x => x.VatAmount).HasColumnName("VatAmount");
            entity.Property(x => x.Remarks).HasColumnName("ExpenseRemarks").IsUnicode(false);
            entity.Property(x => x.Status).HasColumnName("ExpenseStatus").HasMaxLength(5).IsUnicode(false);
            ...
            entity.Property(x => x.WorkWith).HasColumnName("WorkWith").HasMaxLength(50);
            entity.Property(x => x.ServiceNumber).HasColumnName("ServiceNumber").HasMaxLength(50);
            entity.Property(x => x.Instrument).HasColumnName("Instrument").HasMaxLength(50);
            entity.Property(x => x.SerialNumber).HasColumnName("SerialNumber").HasMaxLength(50);
            entity.Property(x => x.MinusDays).HasColumnName("MDays").HasMaxLength(10).IsUnicode(false);
            entity.Property(x => x.Computation).HasColumnName("Computation").HasMaxLength(255).IsUnicode(false);
            entity.Property(x => x.TotalDays).HasColumnName("TotDays").HasMaxLength(10).IsUnicode(false);
