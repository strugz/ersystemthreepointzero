...
public sealed class ApprovalReminderMessageTests
{
    ...
    {
        var messages = new ApprovalReminderMessageFactory(Settings).Create(CreateCandidate(), 3);
    ...
    public void Falls_back_to_report_id_and_sanitizes_the_completed_sms()
    {
        ...
        var messages = new ApprovalReminderMessageFactory(Settings).Create(candidate, 6);
