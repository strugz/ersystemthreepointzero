...
Namespace Infrastructure.Configuration
    Friend Class SettingsRegistryProvider
        Private Const RootPath As String = "HKEY_CURRENT_USER\Software\ER System"
        Private Const SettingsSubKey As String = "Settings"
        ...
        Public Function GetValue(valueName As String) As String
            ...
            Dim values As List(Of String) = loader.RegistryGetValue("Software\ER System\Settings", {valueName})
        ...
        Public Sub Save(valueNames As String(), values As String())
            ...
            Dim loader As New ClsLoadData()
            loader.RegistrySettings(RootPath, SettingsSubKey, valueNames, values)
        End Sub
    End Class
End Namespace
